...
@section('content')
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table id="case_list" class="table">
                            ...
                            <tr>
                                <th width="5%">No</th>
                                <th width="30%">Client Detail</th>
                                <th width="50%">Procedure Details</th>
    ...
    <input type="hidden" name="case_url"
           id="case_url"
           value="{{ url('admin/procedureCaseList') }}">
...
@push('js')
    <script src="{{asset('assets/js/case/procedure-datatable.js')}}"></script>
@endpush
